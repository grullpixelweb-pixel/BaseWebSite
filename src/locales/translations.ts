export const translations = {
  pt: {
    ...
    cart: {
      title: "Seu Projeto Web",
      empty: "Por favor, selecione módulos.",
      totalBg: "Total",
      checkout: "Completar no WhatsApp",
      whatsappHeader:
        "Bem-vindo a Grull Picture Web!%0A%0ASabemos que tem interesse em:%0A%0A",
      whatsappTotal:
        "%0A%0AEm breve responderemos assim que processarmos o pedido.%0ATotal: %s",
    },
    footer: {
      text: "Forjando seu território.",
      links: "Links",
      connect: "Conecte-se",
  ...
  en: {
    ...
    cart: {
      title: "Your Cart",
      empty: "Select some modules.",
      totalBg: "Total",
      checkout: "Submit to WhatsApp",
      whatsappHeader:
        "Welcome to Grull Picture Web!%0A%0AWe know you are interested in:%0A%0A",
      whatsappTotal:
        "%0A%0AWe will reply shortly as soon as we process your order.%0ATotal: %s",
    },
    footer: {
      text: "We craft futures.",
      links: "Quick links",
      connect: "Connect",
